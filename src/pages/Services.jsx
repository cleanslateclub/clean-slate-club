...
const services = [
  ...
  },
  {
    ...
    tagline: 'Deep cleaning and household reset.',
    description: 'Real cleaning support when everything needs it. We wash dishes, fold laundry, clean bathrooms, wipe surfaces, refresh beds, and reset your home to baseline. The work that feels endless when you do it alone.',
    focus: ['Dish washing', 'Laundry (wash & fold)', 'Bathroom cleaning', 'Surface wiping', 'Bed linen refresh', 'Trash & recycling reset'],
    price: '$150–$300',
    duration: '3–5 hrs',
    color: '#EB9486',
    bg: '#fef0ee',
  ...
  },
  {
    key: 'room_service',
    label: 'Room Service',
    tagline: 'Organization and decluttering — not cleaning.',
    description: 'Thoughtful decluttering, sorting, and organization for any space — closets, pantries, playrooms, home offices. We help you pare down, zone, label, and build systems that actually work. (We do NOT do deep cleaning.)',
    focus: ['Decluttering & sorting', 'Closet organization', 'Pantry zoning & labeling', 'Donation prep', 'Space planning', 'System setup'],
    price: '$140–$280',
    duration: '3–5 hrs',
    color: '#B58A90',
    bg: '#f7edef',
