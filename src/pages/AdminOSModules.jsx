...
import BackendModulesTab from '@/components/admin/BackendModulesTab';

export default function AdminOSModules() {
  return (
      ...
      <div className="bg-warm-white border-b border-taupe/15 px-6 py-4">
        <div className="max-w-7xl mx-auto flex items-center justify-between gap-4 flex-wrap">
          <div>
            ...
            <h1 className="font-logo text-2xl text-coral leading-tight">Backend Feature Map</h1>
          </div>
