      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-12 pt-24 pb-16 w-full">
        <div className="max-w-xl">
          ...
          <motion.div
            ...
            <h1 className="font-body font-light md:text-5xl lg:text-[3.5rem] leading-[1.1] mb-2 text-lg text-[hsl(var(--chart-2))] uppercase tracking-widest">You deserve a home
