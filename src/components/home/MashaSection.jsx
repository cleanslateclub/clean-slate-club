...
export default function MashaSection() {
  return (
    <section className="py-24 lg:py-36 bg-warm-white relative overflow-hidden">
      {/* Background accent */}
      <div className="absolute top-0 right-0 w-[600px] h-[600px] rounded-full opacity-10 pointer-events-none" style={{ background: 'radial-gradient(circle, #EFB988 0%, transparent 70%)', transform: 'translate(30%, -20%)' }} />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          <AnimatedSection>
            <div className="relative">
              {/* Blob behind image */}
              <div className="absolute -top-8 -left-8 w-[110%] h-[110%] rounded-full opacity-20 pointer-events-none" style={{ background: 'radial-gradient(circle, #CAE7B9 30%, transparent 75%)' }} />
              <img
              ...
              />
              {/* Floating quote card */}
              <div className="absolute -bottom-6 -right-4 lg:-right-8 bg-white p-5 rounded-2xl shadow-xl shadow-charcoal/8 max-w-[200px]">
          ...
          <AnimatedSection delay={0.2}>
            ...
            <div className="mt-10 p-6 rounded-2xl bg-sage/10 border border-sage/20">
