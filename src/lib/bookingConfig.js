...
export const SERVICE_CONFIG = {
  consult: {
    ...
    baseMinutes: 15,
    priceRange: [0, 0],
    description: "Not sure where to start? Book a free 15-minute conversation and we'll figure it out together. No commitment, no pressure.",
    examples: [
  ...
  errands: {
    label: "The Runaround",
    sublabel: "Errands & Transportation",
    color: "#CAE7B9",
    baseMinutes: 120,
    priceRange: [150, 285],
    hourlyRate: [75, 95],
  ...
  meal_prep: {
    ...
    addons: [
      ...
      { id: "kitchen_deep_clean", label: "Post-Prep Kitchen Cleanup", minutes: 30, price: 25 },
      { id: "fridge_refresh", label: "Fridge Refresh — Cleanout & Reorganize", minutes: 30, price: 65 },
      { id: "pantry_party", label: "Pantry Party — Straighten & Zone", minutes: 45, price: 95 },
