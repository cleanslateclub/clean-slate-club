...
export const isActiveMember = (profile = {}) => normalize(profile.membership_status) === MEMBERSHIP_STATUS.active;
...
export const buildMembershipSnapshot = (profile = {}) => ({
  status: normalize(profile.membership_status) || MEMBERSHIP_STATUS.none,
